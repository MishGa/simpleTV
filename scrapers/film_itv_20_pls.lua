-- скрапер TVS для загрузки видео плейлиста "Фильмы" https://itv.rt.ru (30/12/19)
	...
	local function LoadFromSite(p)
		...
		m_simpleTV.OSD.ShowMessageT({text = '«Фильмы» загрузка ...', color = 0xff9bffff, showTime = 1000 * 200, id = 'channelName'})
