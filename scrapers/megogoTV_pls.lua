-- скрапер TVS для загрузки плейлиста "megogoTV" https://megogo.ru (9/9/20)
-- Copyright © 2017-2020 Nexterr
-- необходим видоскрипт: megogoTV
...
-- ##
	...
	function LoadFromSite(login, pass)
		require 'json'
