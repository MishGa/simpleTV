-- скрапер TVS для загрузки плейлиста "Регионы" (15/9/20)
...
-- ##
	...
	function GetList(UpdateID, m3u_file)
		...
		local outm3u, err = tvs_func.get_m3u(decode64('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL05leHRlcnIvc2ltcGxlVFYucGxheWxpc3RzL21hc3Rlci9yZWdpb25zLnR4dA'))
		if err ~= '' then
