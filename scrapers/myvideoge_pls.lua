-- скрапер TVS для загрузки плейлиста "myvideoge" http://tv.myvideo.ge (31/7/20)
-- необходим видоскрипт: myvideoge
-- ## прокси ##
local proxy = ''
-- '' - нет
...
-- ##
	...
	function LoadFromSite()
		local session = m_simpleTV.Http.New('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36', proxy, false)
