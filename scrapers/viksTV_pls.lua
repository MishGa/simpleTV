-- скрапер TVS для загрузки плейлиста "viksTV" http://online.viks.tv (28/9/20)
-- Copyright © 2017-2020 Nexterr
-- необходим видоскрипт: viksTV
...
-- ##
	...
	function LoadFromSite()
		...
		local adr, title
		for x = 1, 3 do
			local rc, answer = m_simpleTV.Http.Request(session, {url = 'http://online.viks.tv/page/' .. x})
