-- скрапер TVS для загрузки плейлиста "Веб камеры Череповца" http://www.cmirit.ru (16/8/20)
-- Copyright © 2017-2020 Nexterr
	...
	function GetList(UpdateID, m3u_file)
		...
		local outm3u, err = tvs_func.get_m3u(decode64('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL05leHRlcnIvc2ltcGxlVFYucGxheWxpc3RzL21hc3Rlci9jaGVyZXAudHh0'))
		if err ~= '' then
