-- видеоскрипт для сайта https://www.earthcam.com (32/3/20)
-- открывает подобные ссылки:
-- https://www.earthcam.com/usa/newyork/timessquare/?cam=tstwo_hd
		if m_simpleTV.Control.ChangeAdress ~= 'No' then return end
		if not m_simpleTV.Control.CurrentAdress:match('^https?://www%.earthcam%.com/.+') then return end
	...
	local function showError(str)
		m_simpleTV.OSD.ShowMessageT({text = 'EarthCam ошибка: ' .. str, showTime = 5000, color = ARGB(255, 255, 0, 0), id = 'channelName'})
	end
