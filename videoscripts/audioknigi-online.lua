-- аудиоскрипт для сайта https://audioknigi-online.ru (26/4/20)
...
-- https://audioknigi-online.ru/19544-aleksandr-djuma-tri-mushketera.html
	...
	local function showError(str)
		m_simpleTV.OSD.ShowMessageT({text = 'audioknigi-online ошибка: ' .. str, showTime = 8000, color = ARGB(255, 255, 100, 0), id = 'channelName'})
	end
	...
	m_simpleTV.OSD.ShowMessageT({text = header, color = ARGB(255, 155, 155, 255), showTime = 1000 * 5, id = 'channelName'})
